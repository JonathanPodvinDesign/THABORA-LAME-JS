...
const menuBois = document.querySelector(".matieres--liste li:first-child");
const ulSousMenu = document.querySelector(".matieres--liste li ul");

menuBois.addEventListener("click", () => {
  AfficheSousMenu("Bois");
});

function AfficheSousMenu(Matiere) {
...
document.querySelector(".texte_a_graver").addEventListener("keyup", function() {
